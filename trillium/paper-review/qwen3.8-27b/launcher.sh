...
readonly venv_path="${HYPERAGENTS_VENV_PATH:-/project/rrg-bengioy-ad/mikezhu/venv}"
readonly model_path="${HYPERAGENTS_MODEL_PATH:-/project/rrg-bengioy-ad/mikezhu/model/Qwen3.8-27B}"
