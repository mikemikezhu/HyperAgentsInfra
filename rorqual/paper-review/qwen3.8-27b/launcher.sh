...
# The source SHAs are shared by every Rorqual profile and deliberately versioned
...
readonly experiment_root="${HYPERAGENTS_EXPERIMENT_ROOT:-/lustre10/scratch/mikezhu/HyperAgents/experiments}"
readonly venv_path="${HYPERAGENTS_VENV_PATH:-/lustre09/project/6000167/mikezhu/venv}"
readonly model_path="${HYPERAGENTS_MODEL_PATH:-/lustre09/project/6000167/mikezhu/model/Qwen3.8-27B}"
readonly apptainer_image="${HYPERAGENTS_APPTAINER_IMAGE:-/lustre10/scratch/mikezhu/apptainer_images/hyperagents-text-eaa0a09.sif}"
